    ...
    <div>
        <div class="d-flex justify-content-center">
            <div>
                ...
                <select name="" @change="getTickets()" v-model="limitRows" class="form-control" id="">
            ...
            <div class="justify-content-end ms-2">
                <br>
                <button class="btn btn-info" @click.prevent="getTickets()">Search</button>
            </div>
        </div>
        <br>
...
export default {
    ...
    methods: {        
        async getTickets(page){
            let context = this;
            let params = {'user_id': '', 'limit': context.limitRows, 'q' : context.querySearch, 'page': page};
